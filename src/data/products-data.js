/* 產品資料檔（Excel 的快照）
   ...
   由 tools/products-excel.html 轉出。
   注意：英文欄位（重點英文／產品敘述英文／產品細項英文）目前是直接寫在本檔的譯稿，
   請把 src/data/products-data-en.csv 的內容貼回 xlsx 後再轉檔，xlsx 才會是唯一來源。 */
window.PRODUCT_DATA = [
 {
  "name": "Scale Sheet",
  "name_en": "Scale Sheet",
 ...
 },
 {
  ...
  "highlight_en": "Puncture-resistant and leak-proof — the everyday choice for waste",
 ...
 },
 {
  ...
  "img": "封面-拉繩袋.png",
  "items": "清潔袋、醫療袋、環保拉繩袋",
  "highlight_en": "Pull to close — 30% more capacity, no mess on your hands",
 ...
 },
 {
  ...
  "img": "封面-夾鏈袋.png",
  "items": "密實袋、冷凍袋、夾鏈袋",
  "highlight_en": "Solid feel, tight seal — freshness and order locked in",
